...
![alt text](/images/5f14d408505218/azpe15.png)

ちなみにストレージ アカウントのエンドポイントは、Azure ポータルの "エンドポイント" から一覧確認できます。

![alt text](/images/5f14d408505218/azpe1.png)
...
![alt text](/images/5f14d408505218/azpe14.png)

またこの際、実験3 で自前の DNS サーバーを利用するため、プライベート DNS ゾーンは作成しません。

![alt text](/images/5f14d408505218/azpe2.png)
![alt text](/images/5f14d408505218/azpe3.png)
...
![alt text](/images/5f14d408505218/azpe13.png)
...
![alt text](/images/5f14d408505218/azpe4.png)

"Forward Lookup Zones" を右クリックし、"New Zone..." を選択します。

![alt text](/images/5f14d408505218/azpe5.png)

"privatelink.blob.core.windows.net" のゾーンを作成します。

![alt text](/images/5f14d408505218/azpe6.png)

作成したゾーンに対し、次いで A レコードを追加します。この時、ストレージ アカウント名とプライベート エンドポイントの IP アドレスを指定します。

![alt text](/images/5f14d408505218/azpe7.png)
![alt text](/images/5f14d408505218/azpe8.png)
...
![alt text](/images/5f14d408505218/azpe11.png)

次に、Blob ストレージに対し SSL ハンドシェイクが行われ、実データの通信がその後に続いていることがわかります。

![alt text](/images/5f14d408505218/azpe12.png)
