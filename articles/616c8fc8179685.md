---
title: "ACSS を用いたベストプラクティスに沿う SAP on Azure の展開"
emoji: "🍯"
...
| --- | --- | --- |
| VNet (labacssvnet)| Southeast Asia | 10.23.0.0/22 |
...
[SAP-automation-samples](https://github.com/Azure/SAP-automation-samples.git) を参照して予め確認する必要があります (下記例では、```S4HANA_2021_ISS_v0002ms```)。<br>

```bash
azureuser@installer:~/sap-automation$ export bom_base_name="S4HANA_2021_ISS_v0002ms"
